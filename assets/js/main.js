...
// =========================================================
// BASE DE DATOS DE CULTIVOS (ENRIQUECIDA PARA INFO MODAL)
// =========================================================
const DATOS_CULTIVOS = {
    lechuga: {
        ...
        tiempo_cosecha: '28-35 días',
        ph_ideal: '5.5 - 6.5',
        temp_ideal: '15-22 °C',
        humedad_ideal: '60-70%',
        luz_ideal: '12-16 horas',
        consejos: [
    ...
    fresa: {
        ...
        tiempo_cosecha: '60-90 días',
        ph_ideal: '5.8 - 6.5',
        temp_ideal: '18-24 °C',
        humedad_ideal: '65-80%',
        luz_ideal: '14-16 horas',
        consejos: [
    ...
    cilantro: {
        ...
        tiempo_cosecha: '25-30 días',
        ph_ideal: '6.0 - 7.0',
        temp_ideal: '18-24 °C',
        humedad_ideal: '60-70%',
        luz_ideal: '10-12 horas',
        consejos: [
    ...
    espinaca: {
        ...
        dificultad: '⭐⭐ Media',
        rendimiento: '1-2 kg/m²',
        curiosidad: '¡Popeye no se equivocaba! La espinaca tiene hierro, pero el mito de que tiene más que la carne nació por un error de cálculo de un científico en 1870.'
    }
};

// =========================================================
// 2. BASE DE DATOS DE CULTIVOS (PARA EL SISTEMA)
// =========================================================
const cultivosDB = {
    lechuga: {
        nombre: "Lechuga",
...
function actualizarBlurGuia(rect) {
    ...
    zonas.left.style.cssText = `display:block;left:${l}px;top:${t}px;width:${l}px;height:${Math.max(0, b-t)}px;`;
...
btnInfoCultivo.addEventListener('click', (e) => {
    e.stopPropagation();
    const cultivoSeleccionado = document.getElementById('selectorCultivo').value;
    mostrarInfoCultivo(cultivoSeleccionado);
...
modalOverlay.addEventListener('click', (e) => {
    if (e.target === modalOverlay) cerrarModalCultivo();
});

document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape') cerrarModalCultivo();
});
    ...
    modalBody.innerHTML = `
        ...
        <div class="modal-seccion">
            ...
            <div class="modal-grid-iconos">
                <div class="modal-item-icono">
                    <span class="icono-grande">⏳</span>
                    <span class="etiqueta">Cosecha</span>
                    <span class="valor">${data.tiempo_cosecha}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">🧪</span>
                    <span class="etiqueta">pH ideal</span>
                    <span class="valor">${data.ph_ideal}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">🌡️</span>
                    <span class="etiqueta">Temp. ideal</span>
                    <span class="valor">${data.temp_ideal}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">💧</span>
                    <span class="etiqueta">Humedad</span>
                    <span class="valor">${data.humedad_ideal}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">☀️</span>
                    <span class="etiqueta">Luz</span>
                    <span class="valor">${data.luz_ideal}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">📊</span>
                    <span class="etiqueta">Dificultad</span>
                    <span class="valor">${data.dificultad}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">📦</span>
                    <span class="etiqueta">Rendimiento</span>
                    <span class="valor">${data.rendimiento}</span>
                </div>
                <div class="modal-item-icono">
                    <span class="icono-grande">🌱</span>
                    <span class="etiqueta">Tipo</span>
                    <span class="valor">${data.tipo}</span>
                </div>
            </div>
        </div>
